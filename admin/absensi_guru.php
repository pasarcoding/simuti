    ...
    <div class="box">
      ...
      <form action='' method='POST'>
        ...
        <div class='box-footer'>
          ...
          ?>
             <button type='submit' name='simpan' class='btn btn-info pull-left'>Simpan Absensi</button>
         <button type='submit' name='simpan_pulang' class='btn btn-danger pull-right'>Simpan Pulang</button>
        </div>
