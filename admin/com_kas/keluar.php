                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    $sql = mysqli_query($conn,"SELECT * FROM kas WHERE jenis = 'keluar' ");
                                ...
                                ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="index.php?view=kaskel&hapus&id=<?php echo $data['kode'];?>" class="btn btn-danger btn-sm" title="Hapus Data"><i class="fa fa-trash"> </i></a>
                                            </td>
                                        </tr>
                                        <?php 
...
$sql = mysqli_query($conn,"DELETE FROM kas WHERE kode = '$id' ");
	...
	if($sql) {
                            ...
                            echo "
                                ...
                                document.location='index.php?view=kaskel';
                                </script>";  
                        }
                    }
...
?>
          ...
          $newID_2 = $char_2.sprintf("%05s", $noUrut_2);  ?>
                    ...
                    if(isset($_POST['simpan'])) {
                        ...
                        $sql = mysqli_query($conn,"INSERT INTO kas (kode, keterangan, tgl, jumlah, jenis, keluar) VALUES ('$kode', '$ket', '$tgl', 0, 'keluar', '$jml')");
                                ...
                                <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        if(isset($_POST['ubah'])) {
                                            ...
                                            $sql = mysqli_query($conn,"UPDATE kas SET keterangan = '$ket', tgl = '$tgl', jumlah = 0, jenis = 'keluar', keluar = '$jml' WHERE kode = '$kode' ");
                                            if($sql) {
                                                echo "
                                                    <script>
