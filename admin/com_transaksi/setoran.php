...
?>
  ...
  <div class="col-md-3 col-sm-12 col-xs-12" style="margin-left: 0px;">
    <h4><small>Total Saldo Tabungan : </small>Rp. <?php echo rupiah($saldo_keseluruhan); ?></h4>
  </div>
        ...
        <div class="box-body">
          <table id="example1" class="table table-responsive no-padding table-striped">
            ...
            <tbody>
              <?php
              $no = 0;
              $query = mysqli_query($conn,"SELECT * FROM transaksi JOIN siswa ON transaksi.idSiswa=siswa.idSiswa order by id_transaksi asc WHERE metode='Transfer'");
              $count = 2;
