												...
												<tr>
													<td>
														<div class="input-group date">
															...
															<input type="text" name="tgl1" id="tgl1" class="form-control pull-right date-picker" required="" autocomplete="off"">
														</div>
														<!-- /.input group -->
													</td>
													<td>
														<div class="input-group date">
															...
															<input type="text" name="tgl2" id="tgl2" class="form-control pull-right date-picker" required="" autocomplete="off">
														</div>
														<!-- /.input group -->
													</td>
												</tr>
			...
			<div class="box box-danger box-solid">
				...
				<div class="box-body">
					...
					<table class="table table-striped table-hover">
						...
						<td class='text-center'>
							<a class='btn btn-info btn-xs $btnwa' title='Kirimkan Notifikasi Tagihan' href='https://api.whatsapp.com/send?phone=$dts[noHpOrtu]&text=Assalamualaikum Wr Wb, Ayah/Bunda mengingatkan untuk segera menyelesaikan pembayaran Tagihan $rtb[nmJenisBayar] peserta didik a/n *$dts[nmSiswa]* sebesar  *" . buatRp($sisaTagihanBebas) . "* , Terima kasih. ' target='_blank'><span class='fa fa-commenting'></span>Kirim Tagihan</a>
						</td>
						</tr>";
								$no++;
							}
