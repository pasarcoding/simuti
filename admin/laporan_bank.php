	...
	<div class="box box-info box-solid">
		...
		<div class="table-responsive">
			<form method="GET" action="" class="form-horizontal">
				<input type="hidden" name="view" value="lapbank" />
	...
	?>
		<div class="box box-info box-solid">
			...
			<div class="box-footer">
				<a class="btn btn-success" target="_blank" href="./excel_buku_bank.php?tahun=<?php echo $_GET['tahun']; ?>&posBayar=<?php echo $_GET['posBayar']; ?>&bulan=<?php echo $_GET['bulan']; ?>"><span class="fa fa-file-excel-o"></span> Export ke Excel</a>
