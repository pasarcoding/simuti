...
<div class="col-xs-12">
	<div class="box box-info box-solid">
		...
		<div class="table-responsive">
			<form method="GET" action="" class="form-horizontal">
				<input type="hidden" name="view" value="laptunai" />
	...
	?>
		<div class="box box-info box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><span class="fa fa-file-text-o"></span> Buku Pembantu Bank <?php echo $dBayar['nmJenisBayar']; ?></h3>
			</div><!-- /.box-header -->
			<div class="box-body">
				<table class="table table-bordered table-striped" id="example1">
					...
					<tbody>
						...
						// 		WHERE jenis_bayar.idPosBayar='$jenis' AND tagihan_bulanan.statusBayar!='0'  AND MONTH(tagihan_bulanan_bayar.tglBayar) = '$idBulan'  AND YEAR(tagihan_bulanan_bayar.tglBayar) = '$tahun' AND tagihan_bulanan_bayar.caraBayar='$caraBayar' ORDER BY tagihan_bulanan.tglBayar ASC");
						...
						// 	WHERE jenis_bayar.idPosBayar='$jenis' AND tagihan_bebas.statusBayar<>'0' AND MONTH(tagihan_bebas_bayar.tglBayar) = '$idBulan' AND YEAR(tagihan_bebas_bayar.tglBayar) = '$tahun' AND tagihan_bebas_bayar.caraBayar='$caraBayar'  ORDER BY tagihan_bebas_bayar.tglBayar ASC");
						// }
						...
						FROM
						jurnal_umum
						WHERE MONTH(tgl) = '$idBulan' AND YEAR(tgl)='$tahun' and caraBayar='$caraBayar' and idPosBayar='$jenis' ORDER BY tgl ASC");
					...
					<tr>
						<td colspan="5" align='right'><b>Sub Total Buku Kas Tunai</b></td>
			...
			<div class="box-footer">
				<a class="btn btn-success" target="_blank" href="./excel_buku_tunai.php?tahun=<?php echo $_GET['tahun']; ?>&posBayar=<?php echo $_GET['posBayar']; ?>&bulan=<?php echo $_GET['bulan']; ?>"><span class="fa fa-file-excel-o"></span> Export ke Excel</a>
			</div>
		</div><!-- /.box -->
	<?php
