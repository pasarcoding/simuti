          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <div class="input-group">
                <input type="text" class="form-control" autofocus="" name="nis" id="nis" placeholder="NIS Siswa" required="" value="<?= $_GET['nis'] ?>">
          ...
          <div class="box-body table-responsive">
            <table id="example1" class="table table-hover dataTable no-footer">
              ...
              <tbody>
                <?php
                if ($idUnitUsers != '0') {
                  $tampil = mysqli_query($conn, "SELECT siswa.*, kelas_siswa.nmKelas FROM siswa 
                        LEFT JOIN kelas_siswa ON siswa.idKelas = kelas_siswa.idKelas 
                         ORDER BY siswa.idSiswa DESC");
                } else {
                  $tampil = mysqli_query($conn, "SELECT siswa.*,  kelas_siswa.nmKelas FROM siswa 
                        LEFT JOIN kelas_siswa ON siswa.idKelas = kelas_siswa.idKelas 
                        ORDER BY siswa.idSiswa DESC");
...
<?php if (isset($_GET['thn_ajar']) && isset($_GET['nis'])) {
  ...
  $siswa = mysqli_fetch_array(mysqli_query($conn, "SELECT siswa.*,  kelas_siswa.nmKelas FROM siswa LEFT JOIN kelas_siswa ON siswa.idKelas = kelas_siswa.idKelas WHERE siswa.nisSiswa='$_GET[nis]'"));
  ...
  <div class="col-md-12">
    ...
    <div class="box box-success">
      <div class="box-header with-border">
        ...
        <a href="buku_tahfidz.php?thn_ajar=<?= $_GET[thn_ajar]?>&nis=<?= $siswa[nisSiswa]; ?>" target="_blank" class="btn btn-danger btn-xs pull-right">Cetak Buku Tahfidz</a>
      </div><!-- /.box-header -->
      <div class="box-body">
        <div class="col-md-9">
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  if (isset($_POST['tambah'])) {
                    $query = mysqli_query($conn, "INSERT INTO siswa_tahfidz(siswa,tahuAjaran,tanggal,jumlahHafalan, keteranganHafalan,stdel) VALUES ('$_POST[tahfidz_id_siswa]','$_POST[tahfidz_periode]','$_POST[tahfidz_tanggal]','$_POST[tahfidz_jumlah_hafalan]','$_POST[tahfidz_keterangan_hafalan]','0')");
                    if ($query) {
            ...
            <div class="tab-pane" id="tab_2">
              <div class="box-body table-responsive">
                ...
                if (isset($_POST['hapus'])) {
                  $query = mysqli_query($conn, " UPDATE siswa_tahfidz SET stdel='1' WHERE id='$_POST[id]'");
                  if ($query) {
                  ...
                  <tbody>
                    ...
                    while ($r = mysqli_fetch_array($tampil)) {
                      echo '<tr>
                                    ...
                                    <td>
                                    <a href="#del' . $r['id'] . '" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="" data-original-title="Hapus"></i></a>
                                    </td>
                                  </tr>';

                      echo '<div class="modal modal-default fade" id="del' . $r['id'] . '">
            ...
            <div class="tab-pane" id="tab_3">
              <div class="box-body table-responsive">
                <table class="table table-bordered" style="white-space: nowrap;">
                  ...
                  <tbody>
                    <?php
                    $tampil = mysqli_query($conn, "SELECT sum(siswa_tahfidz.jumlahHafalan) as total_hafalan, siswa.nisSiswa, siswa.nmSiswa, kelas_siswa.nmKelas 
                            FROM siswa_tahfidz
                            LEFT JOIN siswa ON siswa_tahfidz.siswa = siswa.idSiswa 
                            LEFT JOIN kelas_siswa ON siswa.idKelas = kelas_siswa.idKelas
                            WHERE siswa_tahfidz.siswa = '$siswa[idSiswa]' AND siswa_tahfidz.tahuAjaran='$_GET[thn_ajar]' AND siswa_tahfidz.stdel='0' GROUP BY siswa_tahfidz.siswa AND siswa_tahfidz.tahuAjaran");
                    $no = 1;
                    while ($r = mysqli_fetch_array($tampil)) {
                      echo '<tr>
                                    <td>' . $no++ . '</td>
