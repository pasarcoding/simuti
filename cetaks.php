...
<body>
  ...
  ?>
    ...
    <table border="1" class="table table-bordered table-striped">
      ...
      <?php
      $querys = "SELECT DATE_FORMAT(transaksi.tanggal, '%Y-%m-%d') as tgl,
...
transaksi.keterangan,
  ...
  FROM transaksi JOIN siswa ON transaksi.nisnSiswa=siswa.nisnSiswa WHERE  (tanggal BETWEEN '$id1' AND '$id2') order by id_transaksi asc "; // Tampilkan semua data gambar
      $query = "SELECT DATE_FORMAT(transaksi.tanggal, '%Y-%m-%d') as tgl,
					...
					transaksi.keterangan,
                    transaksi.kredit    
                FROM transaksi JOIN siswa ON transaksi.nisnSiswa=siswa.nisnSiswa WHERE siswa.idKelas='$Kelas' and (tanggal BETWEEN '$id1' AND '$id2') order by id_transaksi asc "; // Tampilkan semua data gambar
      $sql = mysqli_query($conn, $query); // Eksekusi/Jalankan query dari variabel $query
      $sqls = mysqli_query($conn, $querys); // Eksekusi/Jalankan query dari variabel $query
