...
header("Content-Disposition: attachment; filename=laporan_buku_tunai_" . str_replace(" ", "_", $posBayar['nmPosBayar']) . "_" . date('dmyHis') . ".xls");
?>
<table border="1">
	<center>
		<h2>BUKU KAS TUNAI</h2>
		<h3>Periode 1 s.d 30/31 <?php echo $nama_bulan_terpilih . ' ' . $tahun; ?></h3>
	</center>
	...
	<tbody>
		...
		foreach ($results as $result) {
			...
			echo "<tr>
								...
								<td align='left'>" . buatRp($result['jumlahBayar']) . "</td>
								<td align='left'>" . buatRp($result['pengeluaran']) . "</td>
								<td align='left'>" . buatRp($saldo) . "</td>
							</tr>";
			$no++;
	...
	<tr>
		<td colspan="4" align='right'><b>Sub Total Buku Kas Tunai</b></td>
