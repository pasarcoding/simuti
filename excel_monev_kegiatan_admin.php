...
if (empty($_GET['unit'])) {
$whereQuery = "WHERE 1=1";  // Filter berdasarkan unit
$where = "";
...
header("Content-Disposition: attachment; filename=Monev_Kegiatan_ ". $where . "_" . date('Y-m-d') . ".xls");
echo "<center>
    <h3>" . strtoupper($idt['nmSekolah']) . "</h3>
</center>";
echo "<center>
    <h3> MONEV KEGIATAN " . strtoupper($where) . " BULAN " . strtoupper($bulanNama) . "</h3>
</center>";
echo "<center>
