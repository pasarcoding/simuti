...
if ($_GET['aksi'] == '') { ?>
  ...
  <div class="col-md-6">
    <div class="box box-solid box-primary">
      <div class="box-header with-border">
        <h3>Laporan Periode <small></small></h3>
        <div class="form-group"></div>
        <form action="?view=laptransaksi&aksi=periode" enctype="multipart/form-data" method="POST">
 ...
 <div class="col-md-6">
  <div class="box box-solid box-primary">
    <div class="box-header with-border">
      <h3>Laporan Saldo  siswa</h3>
      <form action="cetakdatasiswa.php" method="GET" target="output">
        ...
        <button type="submit" name="pdf" class="btn btn-warning btn-sm">
          <i class="glyphicon glyphicon-print"></i> Cetak Laporan Saldo siswa
        </button>
         <button type="submit" name="excel" class="btn btn-success btn-sm">
          <i class="fa fa-file-excel-o"></i> Excel Laporan Saldo siswa
        </button>
      </form>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="box box-solid box-primary">
      <div class="box-header with-border">
        ...
        <div class="form-group"></div>
        <div class="x_content">
          <form action="?view=laptransaksi&aksi=siswa" enctype="multipart/form-data" method="POST">
                  ...
                  <table id="example1" class="table table-responsive no-padding table-striped">
                    ...
                    <tbody>
                      ...
                      if ($Kelas != 'Semua Kelas') {
                        $query = mysqli_query($conn, "SELECT * FROM transaksi JOIN siswa ON transaksi.nisnSiswa=siswa.nisnSiswa WHERE siswa.idKelas='$Kelas' and (tanggal BETWEEN '$tanggal1' AND '$tanggal2') order by id_transaksi asc ");
                        $count = 2;
