...
<script>
  function ambil_data(id) {
    ...
    window.location.href = '?view=<?= $_GET['view'] ?>&thn_ajar=' + thAjaran + '&id=' + id;
  }
</script>
                ...
                <div class="row">
                  ...
                  if (isset($_POST['tambah'])) {
                    ...
                    if ($query) {
                      ...
                      echo "<script>document.location='?view=$_GET[view]&thn_ajar=$_GET[thn_ajar]&id=$_GET[id]';</script>";
                    } else {
                  ...
                  <form action="?view=<?= $_GET[view] ?>&thn_ajar=<?= $_GET[thn_ajar] ?>&id=<?= $_GET[id] ?>" method="post" accept-charset="utf-8">
