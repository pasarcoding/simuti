      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <?php if ($_GET[view] == 'home') {
            ...
            echo "</div>";
          } elseif ($_GET[view] == 'rab') {

            echo "<div class='row'>";
            include "bendahara/master_rab.php";
            echo "</div>";
          } elseif ($_GET[view] == 'rab_setuju') {

            echo "<div class='row'>";
            include "bendahara/master_rab_setuju.php";
            echo "</div>";
          } elseif ($_GET[view] == 'pembayaran') {
            ...
            echo "<div class='row'>";
            include "bendahara/com_transaksi/nasabah.php";
            echo "</div>";
          } elseif ($_GET[view] == 'transaksi') {

            echo "<div class='row'>";
            include "bendahara/com_transaksi/transaksi.php";
            echo "</div>";
          } elseif ($_GET[view] == 'transaksi_yatim') {

            echo "<div class='row'>";
            include "bendahara/com_transaksi/transaksi_yatim.php";
            echo "</div>";
          } elseif ($_GET[view] == 'laporan-transaksi') {

            echo "<div class='row'>";
            include "bendahara/com_transaksi/laporan-transaksi.php";
            echo "</div>";
