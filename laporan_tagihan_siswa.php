...
include "config/fungsi_indotgl.php";
    ...
    $tag_bln = mysqli_query($conn,"SELECT tagihan_bulanan.idSiswa, tagihan_bulanan.jumlahBayar,
                    ...
                    WHERE tagihan_bulanan.idSiswa='$dsw[idSiswa]' AND jenis_bayar.idTahunAjaran<='$thn_ajar' AND tagihan_bulanan.statusBayar!='1' AND tagihan_bulanan.idBulan='$id_bln'
   ...
   $tag_bebas = mysqli_query($conn,"SELECT tagihan_bebas.*, 
                          ...
                          WHERE tagihan_bebas.idSiswa='$dsw[idSiswa]' AND jenis_bayar.idTahunAjaran<='$thn_ajar' AND tagihan_bebas.statusBayar!='1' AND tagihan_bebas.idBulan='$id_bln'
				...
				<div class="box-header with-border">
					...
					<table width="100%" style="margin-top:10px;margin-bottom:10px;">
						...
						<tr>
							...
							<td></td>
							<td style="float:right">Bulan : <?= $bulan_thn ?></td>
						</tr>
						<tr>
							<td>Kelas</td>
							<td>: </td>
                                ...
                                $sisa_tag_bulan = $tBln['jumlahBayar'] - $bayar_bulan['totalBayarBulanan'];
                                 if ($sisa_tag_bulan <> 0){
                                    echo '<tr>
                                            ...
                                            <td align="right">'.buatRp($sisa_tag_bulan).' / Belum Lunas</td>';
