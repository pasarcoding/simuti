	...
	<font face="Arial">
		...
		switch ($_GET['view']) {
			...
			case 'kelas':
				...
				break;
			case 'rab':
				$judul = "<span class='fa fa-paper-plane-o'></span> RAB";
				$aktifRAB = 'active';
				$aktifRAB1 = 'active';
				break;
			case 'rab_setuju':
				$judul = "<span class='fa fa-paper-plane'></span> Setujui RAB";
				$aktifRAB = 'active';
				$aktifRAB2 = 'active';
				break;
				//menu keuangan
		...
		<ul class="sidebar-menu">
			...
			<!-- <li class="<?php echo $aktifRAB1; ?>"><a href="?view=rab"><i class="fa fa-paper-plane "></i><span> List Pengajuan</span></a></li> -->
			<li class="treeview <?php echo $aktifK; ?>">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php echo $aktifK1; ?>"><a href="index-bendahara.php?view=nasabah"><i class="fa fa-users "></i><span> Nasabah</span></a></li>
					<li class="<?php echo $aktifK3; ?>"><a href="index-bendahara.php?view=transaksi"><i class="fa fa-money"></i><span> Tabungan</span></a></li>
					<!-- <li class="<?php echo $aktifK4; ?>"><a href="index-bendahara.php?view=transaksi_yatim"><i class="fa fa-money"></i><span> Tabungan Yatim</span></a></li> -->
					<li class="<?php echo $aktifK5; ?>"><a href="index-bendahara.php?view=laporan-transaksi"><i class="fa fa-print "></i><span> Lap.Transaksi </span></a></li>
				</ul>
			</li>
