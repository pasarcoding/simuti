<section class="sidebar">
	<font face="Arial">
		...
		<ul class="sidebar-menu">
			...
			<li class="<?php echo $aktif; ?>"><a href="index-siswa.php?view=laptransaksis"><i class="fa fa-leanpub "></i><span> Transaksi Tabungan</span></a></li>
			<!-- <li class="<?php echo $aktif; ?>"><a href="index-siswa.php?view=laptransaksis_yatim"><i class="fa fa-leanpub "></i><span> Transaksi Tabungan Yatim</span></a></li> -->

			<li class="<?php echo $aktif; ?>"><a href="index-siswa.php?view=laptanggungan"><i class="fa fa-money"></i><span>Riwayat Pembayaran </span></a></li>
