  ...
  <div class="col-xs-12">
    <div class="box box-solid box-primary">
      <div class="box-header with-border">
        <h2>Riwayat Transaksi Tabungan Yatim Anda <small></small></h2>

        <div class="form-group"></div>

        <div class="box-body">
          <form action="?view=laptransaksis_yatim&aksi=siswa" enctype="multipart/form-data" method="POST">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-danger box-solid">
      <div class="box-header with-border">
        ...
        <!-- /. tools -->
        <h3 class="box-title">Riwayat Transaksi tabungan Yatim</h3>
      </div><!-- /.box-header -->
        ...
        <div class="table-responsive">
          <table id="example1" class="table table-responsive no-padding table-striped">
            ...
            <tbody>
              ...
              $no = 0;
              $query = mysqli_query($conn,"SELECT * FROM transaksi_yatim JOIN siswa ON transaksi_yatim.nisnSiswa=siswa.nisnSiswa WHERE (tanggal BETWEEN '$tgl1' AND '$tgl2') AND transaksi_yatim.nisnSiswa= '$r[nisnSiswa]' order by id_transaksi asc ");
