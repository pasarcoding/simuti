...
if (isset($_SESSION[id])) {
	...
	$dBayar = mysqli_fetch_array(mysqli_query($conn,"SELECT tagihan_bebas.*,
...
?>
	...
	<body style="font-size:80%;">
		...
		$sqlTagihan = mysqli_query($conn,"SELECT
		...
		WHERE tagihan_bebas_bayar.idTagihanBebas='$_GET[tagihan]'");
		?>
		<div class="col-xs-12">
			<table width="100%">
				<tr>
				...
				<div class="box-body">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							$no = 1;
							while ($dTagihan = mysqli_fetch_array($sqlTagihan)) {
								echo "<tr>
							...
							<td align='right'>$dTagihan[ketBayar]</td>
								...
								$no++;
								$total += $dTagihan['jumlahBayar'];
							}
							echo "<tr>
							<td><b>Grand Total : </b></td>
							<td align='right'><b>" . buatRp($total) . "</b></td>
							<td align='right'></td>
							<td align='right'></td>
							</tr>";
							?>
		...
		<table width="100%">
			<tr>
				<td valign="top">
					<b>Terbilang :</b><br>
					<i><?php echo terbilang($total); ?> rupiah</i>
				</td>
				<td align="center"></td>
