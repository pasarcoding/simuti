...
?>
	...
	<body style="font-size:80%;">
		...
		$dTagihan = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM tagihan_bulanan_bayar WHERE idTagihanBulananBayar='$tagihan'"));
		$dTagihans = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM view_laporan_bayar_bulanan WHERE idTagihanBulanan='$dTagihan[idTagihanBulanan]'"));

		$nisn = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM siswa WHERE idSiswa='$dTagihans[idSiswa]'"));
		?>
		<div class="col-xs-12">
			<table width="100%">
				<tr>
			...
			<hr style="margin:4px" />
			<center><b>Bukti Pembayaran : <br /><?php echo $dTagihans['nmJenisBayar']; ?></b></center>
			<hr style="margin:4px" />
				...
				<div class="box-header with-border">
					<table width="100%" style="margin-top:10px;margin-bottom:10px;">
						<tr>
							...
							<td width="8"> : </td>
							<td><?php echo $dTagihans['nmSiswa']; ?></td>
							<td></td>
							<td align="right">Kelas : <?php echo $dTagihans['nmKelas']; ?></td>
						</tr>
						<tr>
							<td>NIS/NISN</td>
							<td> : </td>
							<td><?php echo $dTagihans['nisSiswa']; ?>/<?php echo $nisn['nisnSiswa']; ?></td>
							<td></td>
							<td></td>
						</tr>
					</table>
				...
				<div class="box-body">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							echo "<tr>
							<td align='center'>$dTagihans[nmBulan]</td>
							<td align='center'> ".tgl_raport(date($dTagihan[tglBayar]))."<!-- $dTagihan[tglBayar] --></td>
							<td align='center'>$dTagihan[caraBayar]</td>
							<td align='right'>" . buatRp($dTagihan['jumlahBayar']) . "/$dTagihan[ketBayar]</td>
							</tr>";
							?>
						</tbody>
					</table>
		...
		<table width="100%">
			<tr>
				<td valign="top">
					...
					<i><?php echo ucwords (strtolower(terbilang($dTagihan['jumlahBayar']))); ?> Rupiah</i>
				</td>
				<td align="center"></td>
				<td align="center" width="200px">
					<?php echo $idt['kabupaten']; ?>, <?php echo tgl_raport(date("Y-m-d")); ?>
					<br />Penerima,<br /><br /><br /><br />
					<b><u><!-- <?php echo $idt['nmBendahara']; ?></u><br /><?php echo $idt['nipBendahara']; ?> --> <?php echo $_SESSION['namalengkap']; ?></b>
				</td>
			</tr>
		</table>
		<!--<footer></footer>-->
