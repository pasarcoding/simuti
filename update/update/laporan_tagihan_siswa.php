...
include "config/fungsi_indotgl.php";
	...
	$dsw = mysql_fetch_array(mysql_query("SELECT * FROM view_detil_siswa WHERE idSiswa='$_GET[siswa]'"));
	$taa = mysql_fetch_array(mysql_query("SELECT * FROM tahun_ajaran where aktif='Y'"));
    ...
    $tag_bln = mysql_query("SELECT tagihan_bulanan.idSiswa, tagihan_bulanan.jumlahBayar,
                    ...
                    WHERE tagihan_bulanan.idSiswa='$dsw[idSiswa]' AND jenis_bayar.idTahunAjaran<='$tahun' AND tagihan_bulanan.statusBayar='0' AND tagihan_bulanan.idBulan<='$id_bln'
                ");
    $tag_bebas = mysql_query("SELECT tagihan_bebas.*, 
                ...
                LEFT JOIN tahun_ajaran ON jenis_bayar.idTahunAjaran = tahun_ajaran.idTahunAjaran
                LEFT JOIN pos_bayar ON jenis_bayar.idPosBayar = pos_bayar.idPosBayar
                WHERE tagihan_bebas.idSiswa='$dsw[idSiswa]' AND jenis_bayar.idTahunAjaran<='$tahun' AND tagihan_bebas.statusBayar!='1' AND tagihan_bebas.idBulan<='$id_bln'
